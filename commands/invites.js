...
client.on('interactionCreate', async (interaction) => {
    try {
        ...
        // 3. GUILD BUTTON INTERACTIONS (Store, Tickets, Setup, etc.)
        ...
        if (interaction.isModalSubmit()) {
            ...
            if (interaction.customId === 'modal_stats_setup') {
                ...
                return await interaction.editReply({ content: '✅ Stats Configured Successfully!' });
            }
            ...
            if (interaction.customId === 'youtube_modal_submit') {
                ...
                return await interaction.editReply({ content: '✅ YouTube System Connected!' });
            }
            ...
            if (interaction.customId === 'modal_store_cfg') {
                ...
                return await interaction.editReply({ content: '✅ Store Stock & Categories updated.' });
            }
            ...
            if (interaction.customId === 'modal_store_dms') {
                ...
                return await interaction.editReply({ content: '✅ DM Templates saved.' });
            }
            ...
            if (interaction.customId === 'modal_auto_response') {
                ...
                return await interaction.editReply({ content: '✅ Auto-responses updated!' });
            }
        ...
        if (interaction.isStringSelectMenu()) {
            ...
            if (interaction.customId === 'store_category_select') {
                ...
                return await interaction.reply({ content: `📁 **${chosenCat}**`, components: [row], ephemeral: true });
            }
